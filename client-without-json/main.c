...
void login_menu()
{
    ...
    while(state == 1)
    {
        ...
        if (recieve[9] == 'E')//switch behtar bood fek konam
        {
            char temp[100] = {};
            sscanf(recieve + 26, "%[^}]s", temp);
            printf("ERROR : %s\n\n", temp);
        }
        if (recieve[9] == 'A')
        {
...
void karbari_menu()
{
    ...
    while(state == 2)
    {
        ...
        else
        {
            ...
            if((recieve[9] == 'S') && (create_join_logout == 1))
            {
                system("cls");
                state = 3;
                printf("SUCCESSFUL : \"Making ,%s channel was successful.\"\n\n", global_channel_name);
            }
            if((recieve[9] == 'S') && (create_join_logout == 2))
            {
                system("cls");
                state = 3;
                printf("SUCCESSFUL : \"You joined the ,%s channel successfully.\" \n\n", global_channel_name);
            }
            if(recieve[9] == 'E')
            {
                system("cls");
...
void chat_menu()
{
    ...
    while(state == 3)
    {
        ...
        if(send_refresh_member_leave == 4)
        {
            ...
            recv(client_socket, recieve, sizeof(recieve), 0);
            if (recieve[9] == 'S')//halatha check nashodeh
            {
                system("cls");
        ...
        else if(send_refresh_member_leave == 3)
        {
            ...
            char temp[50] = {};
            strncpy(temp, recieve + 26, strlen(recieve) - 29);
            printf("%s\n\n", temp);
        }
        ...
        else if(send_refresh_member_leave == 1)
        {
            ...
            recv(client_socket, recieve, sizeof(recieve), 0);
            system("cls");
            if (recieve[9] == 'S') printf("SUCCESSFULL ! \n\n");
            if (recieve[9] == 'E')
            {
                char temp[100] = {};
                sscanf(recieve + 26, "%[^}]s", temp);
